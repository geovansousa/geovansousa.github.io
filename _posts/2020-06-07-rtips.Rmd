---
layout: post
title: A cheatsheet for base R plot
---

Useful base R parameters' cheatsheet avaiable in [R Graph Gallery](https://www.r-graph-gallery.com/base-R.html).

#### About parameters such as `pch`, `cex` and `col`.
...
#### For inner (`mar`) and outer (`oma`) margins
